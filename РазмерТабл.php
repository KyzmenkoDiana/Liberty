...
<!--первый блок-->
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <a class="me-3 py-2 link-body-emphasis text-dark text-decoration-none"  style="font-family: cursive; font-size: 18px;" href="РазмерТабл.php">РАЗМЕРНАЯ ТАБЛИЦА</a>
    <a class="me-3 py-2 link-body-emphasis text-dark text-decoration-none"  style="font-family: cursive; font-size: 18px;" href="СрокИзгот.php">СРОКИ ИЗГОТОВЛЕНИЯ</a>
</div>
<br>
<span style="font-family: cursive; color: DeepPink; font-size: 60px; margin-left: 100px;text-align: center;">РАЗМЕРНАЯ</span>
<br>
<span style="font-family: cursive; color: DeepPink; font-size: 60px; margin-left: 350px;text-align: center;">ТАБЛИЦА</span> 
<br>
<br>
<br>
<br>
...
<h2 style="text-align: center; color: DeepPink">ДЛЯ ВЗРОСЛЫХ</h2>
<div style="background-color:black; width:100%; height:2px;"></div>
<br>
<body> 
<img src="img/hfpv.jpg" width="650px" hspace="350px">    
<br>
<br>
<div style="background-color:black; width:100%; height:2px;"></div>
<h2 style="text-align: center; color: DeepPink">ДЛЯ ДЕТЕЙ</h2>
<div style="background-color:black; width:100%; height:2px;"></div>
<br>
<img src="img/hfpvl.jpg" width="650px" hspace="350px">    
<br>
<br>
<br>
<br>
