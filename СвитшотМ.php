...
<body>
<span style="font-family: cursive; color: RoyalBlue; font-size: 100px; margin-left: 100px;text-align: center;">СОЗДАЙ СВОЙ</span> 
<span style="font-family: cursive; color: RoyalBlue; font-size: 100px; margin-left: 600px;text-align: center;">СВИТШОТ</span> 
<div class="card-body">
<div class="container md-6">
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        <div class="card-header py-3">
            <div>
            <div class="card-body">
            <img src="img/man/свитшот/<?= $row['Фотография'] ?>"  class="img-thumbnail">
