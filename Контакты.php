...
<!--первый блок (фото) -->
<div>
    <h2 style="font-family: cursive; color: DeepPink; font-size: 100px; text-align: center;">КОНТАКТЫ</h2>
<br>
<br>
<p><img src="img/logo.jpg" width="500" height="400" alt="Иллюстрация" align="left" vspace="5" hspace="15"></p>
    <h2>Контакты: </h2> 
    <p> +79786699887</p>
    <h2>WhatsApp:</h2>
    <p> +79786699887</p>
    <h2>Почта:</h2>
    <p> Liberty.info@gmail.com</p>
    <h5>Шоурум: Никольская улица, 17, офисный центр "Славянский", 1-ый этаж (по коридору вдоль окон, первый поворот налево, третья дверь). Метро: Лубянка, Площадь Революции, Театральная.
Номер шоурума: +7 977 474-14-11
График работы: 10:00-21:00, обед 14:00-15:00
Шоурум You Choose</h5>
<br>
<br>
<br>
