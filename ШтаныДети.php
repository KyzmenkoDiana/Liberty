...
<a class="my-6 mr-md-center div text-align='center' " style="font-family: cursive; color: DeepPink; font-size: 40px;  margin-left: 280px;text-align: center;text-decoration: none" href="index2.php">Liberty</a>
...
<div class="container md-6">
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        <div class="card-header py-3">
            <div>
            <div class="card-body">
            <img src="img/kids/штаны/<?= $row['Фотография'] ?>"  class="img-thumbnail">
...
<div style="position: fixed; bottom: 10px; right: 10px; color: ">
<strong>
Learn Web Coding
</strong>
</div>
...
<style>
     .img-thumbnail{
      background-color: PaleGreen; /* Set your desired background color */
    }
    body{
  background: #F2DEE7;
}
