...
<!--первый блок-->
<blockquote>
<span style="font-family: cursive; color: RoyalBlue; font-size:70px; margin-left: 80px;text-align: center;">ОДЕЖДА</span>
<h1>  
<span style="font-family: cursive; color: RoyalBlue; font-size:70px; margin-left: 200px;text-align: center;">ДЛЯ НЕГО</span> 
<div class="d-md-flex flex-md-equal w-100 my-md-2 ps-md-2">
    ...
    <div class="my-2 p-2">
        <h2 class="display-15" style="font-family: cursive; color: RoyalBlue; font-size: 30px; margin-left: 550px; align=center;">Создай идеальный лук </h2>
        <h2 class="display-15" style="font-family: cursive; color: RoyalBlue; font-size: 30px; margin-left: 550px; align=center;">в конструкторе, где можно настроить</h2>
        <h2 class="display-15" style="font-family: cursive; color: RoyalBlue; font-size: 30px; margin-left: 550px; align=center;">все детали самостоятельно</h2>
    </div>
    </div>
<br>
<br>
...
<div class="row row-cols-1 row-cols-md-2 mb-2 text-center">
    <div class="col">
        ...
        <div class="card-body">
        <img src="img/man/man111.jpg"  class="img-thumbnail" width="267px" height="400" hspace="20px">
        <br>
            <a href="ХудиМ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/man/man222.jpg"  class="img-thumbnail" width="267px" height="400" hspace="20px">
        <br>
            <a href="СвитшотМ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/man/man333.jpg"  class="img-thumbnail" width="383px" height="400" hspace="20px">
        <br>
            <a href="ФутболкаМ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/man/man444.jpg"  class="img-thumbnail" width="267px" height="400" hspace="20px">
        <br>
            <a href="РубашкаМ.php" class="floating-button">Создать</a>
        </div>
        </div>
</div>
</div>
...
<style>
  ...
  .floating-button{
      background-color: SkyBlue; /* Set your desired background color */
    }
    .img-thumbnail{
      background-color: SkyBlue; /* Set your desired background color */
    }
