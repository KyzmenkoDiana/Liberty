...
<!--первый блок-->
<blockquote>
<span style="font-family: cursive; color: DeepPink; font-size: 70px; margin-left: 80px;text-align: center;">ОДЕЖДА </span>
<h1>  
<span style="font-family: cursive; color: DeepPink; font-size: 70px; margin-left: 200px;text-align: center;">ДЛЯ НЕЁ</span> 
<div class="d-md-flex flex-md-equal w-100 my-md-2 ps-md-2">
    ...
    <div class="my-2 p-2">
        <h2 class="display-15" style="font-family: cursive; color: DeepPink; font-size: 30px; margin-left: 550px; align=center;">Создай идеальный лук </h2>
        <h2 class="display-15" style="font-family: cursive; color: DeepPink; font-size: 30px; margin-left: 550px; align=center;">в конструкторе, где можно настроить</h2>
        <h2 class="display-15" style="font-family: cursive; color: DeepPink; font-size: 30px; margin-left: 550px; align=center;">все детали самостоятельно</h2>
    </div>
    </div>
<br>
<br>
...
<div class="row row-cols-1 row-cols-md-2 mb-2 text-center">
    <div class="col">
        ...
        <div class="card-body">
        <img src="img/woman/wom/woman111.jpg" class="img-thumbnail" width="300px"  hspace="150px">
        <br>
            <a href="ХудиЖ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/woman/wom/woman222.jpg"  class="img-thumbnail" width="267px" height="400">
        <br>
            <a href="ФутболкаЖ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/woman/wom/woman333.jpg"  class="img-thumbnail" width="267px" height="400" hspace="20px">
        <br>
            <a href="СвитшотЖ.php" class="floating-button">Создать</a>
        </div>
        </div>
    </div>
    <div class="col">
        <div class=" mb-4 rounded-3 shadow-sm">
        <div class="card-body">
        <img src="img/woman/wom/woman444.jpg"  class="img-thumbnail" width="353px" height="400">
        <br>
            <a href="РубашкаЖ.php" class="floating-button">Создать</a>
        </div>
        </div>
</div>
</div>
