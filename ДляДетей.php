...
<br>
<span style="font-family: cursive; color: ForestGreen; font-size: 90px; margin-left: 100px;text-align: center;">В НАЛИЧИИ ДЛЯ ДЕТЕЙ</span>
...
<footer>
  <br>
  <div class="row">
    <!-- Your existing columns and content here -->
  </div>
</footer>